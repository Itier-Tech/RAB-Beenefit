<div class="sidebar" id="sidebar">
    <img src="/beenefit-logo.png" alt="Logo Beenefit" class="logo-beenefit">
    <div class="sidebar-menu dropdown">
        <div class="dashboard dropdown-toggle">
            <img src="/images/four-dots.png" style="width: 15px; height: 15px;"/>
