    ...
    @if(count($project) > 0)
        ...
        <div style="display:flex; width:100%;">
            ...
            <div class="project-list" style="width:20%; margin-right: 5%; align-self:flex-start;">
                ...
                <form>
                    <input type="checkbox" style="margin-right:5px;" name="inp"><label>Input</label></br>
                    <input type="checkbox" style="margin-right:5px;" name="fin"><label>Finalisasi</label></br>
                    <button style="color:green; border-color: green; background:none; border-radius:5px; margin-top:5px;">Hapus</button>
